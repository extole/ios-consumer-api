//
// RefreshingReportRunnerResponse.swift
//
...
public struct RefreshingReportRunnerResponse: Codable {
    ...
    public init(_id: String? = nil, name: String? = nil, reportTypeName: String? = nil, formats: [Formats]? = nil, createdDate: Date? = nil, updatedDate: Date? = nil, parameters: [String:ReportParameterResponse]? = nil, scopes: [Scopes]? = nil, tags: [String]? = nil, userId: String? = nil, sftpServerId: String? = nil, type: String? = nil, expirationMs: Int64? = nil) {
        self._id = _id
        self.name = name
