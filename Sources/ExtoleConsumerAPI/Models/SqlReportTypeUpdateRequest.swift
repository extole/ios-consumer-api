//
// SqlReportTypeUpdateRequest.swift
//
...
public struct SqlReportTypeUpdateRequest: Codable {
    ...
    public init(type: ModelType? = nil, tags: [ReportTypeTagRequest]? = nil, displayName: String? = nil, _description: String? = nil, categories: [String]? = nil, scopes: [Scopes]? = nil, visibility: Visibility? = nil, formats: [Formats]? = nil, allowedScopes: [AllowedScopes]? = nil, dataStart: Date? = nil, database: Database? = nil, query: String? = nil) {
        self.type = type
        self.tags = tags
