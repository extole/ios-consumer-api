...
public struct RawEvent: Codable {
    ...
    public init(httpRequestMethod: String? = nil, rawEventId: String? = nil, referrer: String? = nil, eventName: String? = nil, url: String? = nil, sourceIps: [String]? = nil, apiType: String? = nil, httpParameters: [String:[String]]? = nil, httpHeaders: [String:[String]]? = nil, httpCookies: [String:[String]]? = nil, httpRequestBody: String? = nil, requestTime: String? = nil, clientDomainContext: ClientDomainContext? = nil) {
