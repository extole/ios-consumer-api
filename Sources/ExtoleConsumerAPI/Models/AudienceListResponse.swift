...
public struct AudienceListResponse: Codable {
    ...
    public init(type: ModelType? = nil, _id: String? = nil, name: String? = nil, tags: [String]? = nil, state: State? = nil, _description: String? = nil, eventColumns: [String]? = nil, eventData: [String:String]? = nil, memberCount: Int64? = nil, lastUpdate: Date? = nil, errorCode: String? = nil) {
        self.type = type
        self._id = _id
        self.name = name
        self.tags = tags
