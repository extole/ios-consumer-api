...
public struct ReportTypeCreateRequest: Codable {
    ...
    public init(type: ModelType? = nil, displayName: String? = nil, _description: String? = nil, categories: [String]? = nil, scopes: [Scopes]? = nil, visibility: Visibility? = nil, formats: [Formats]? = nil, allowedScopes: [AllowedScopes]? = nil, dataStart: Date? = nil, tags: [ReportTypeTagRequest]? = nil) {
        self.type = type
