...
public struct CampaignSummary: Codable {
    ...
    public init(campaignName: String? = nil, firstLaunchDate: String? = nil, lastStoppedDate: String? = nil, lastPausedDate: String? = nil, lastArchivedDate: String? = nil, lastEndedDate: String? = nil, currentState: String? = nil, _description: String? = nil, campaignId: String? = nil, tags: [String]? = nil, programLabel: String? = nil, programType: String? = nil, themeName: String? = nil) {
