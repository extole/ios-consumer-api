...
public struct PersonReward: Codable {
    ...
    public init(dateEarned: String? = nil, _id: String? = nil, state: String? = nil, data: [String:String]? = nil, campaignId: String? = nil, rewardId: String? = nil, rewardSupplierId: String? = nil, personRole: String? = nil, partnerRewardId: String? = nil, faceValue: String? = nil, faceValueType: String? = nil, rewardedDate: String? = nil, sandbox: String? = nil, rewardSlots: [String]? = nil, programLabel: String? = nil) {
