...
open class ZoneEndpoints {
     ...
     */
    open class func render(body: RenderZoneRequest? = nil, completion: @escaping ((_ data: ZoneResponse?,_ error: Error?) -> Void)) {
  ...
  "campaign_id" : "campaign_id"
     ...
     */
    open class func renderWithRequestBuilder(body: RenderZoneRequest? = nil) -> RequestBuilder<ZoneResponse> {
        let path = "/v6/zones"
