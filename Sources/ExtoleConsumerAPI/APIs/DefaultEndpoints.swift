...
open class DefaultEndpoints {
  ...
  "tags" : [ "tags", "tags" ]
    ...
    open class func listAssetsWithRequestBuilder(personId: String) -> RequestBuilder<[PersonAssetResponse]> {
        ...
        let requestBuilder: RequestBuilder<[PersonAssetResponse]>.Type = ExtoleConsumerAPI.requestBuilderFactory.getBuilder()
  ...
  "tags" : [ "tags", "tags" ]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func record(body: CreativeMetricRequest? = nil, completion: @escaping ((_ data: CreativeMetricResponse?,_ error: Error?) -> Void)) {
  ...
  "id" : "id"
     ...
     */
    open class func recordWithRequestBuilder(body: CreativeMetricRequest? = nil) -> RequestBuilder<CreativeMetricResponse> {
        ...
        let requestBuilder: RequestBuilder<CreativeMetricResponse>.Type = ExtoleConsumerAPI.requestBuilderFactory.getBuilder()
