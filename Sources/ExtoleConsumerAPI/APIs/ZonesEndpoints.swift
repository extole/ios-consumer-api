...
open class ZonesEndpoints {
  ...
  "data" : {
    ...
    open class func renderWithRequestBuilder(eventName: String, body: [String:String]? = nil) -> RequestBuilder<ZoneResponse> {
        ...
        let requestBuilder: RequestBuilder<ZoneResponse>.Type = ExtoleConsumerAPIAPI.requestBuilderFactory.getBuilder()
